...
class MumbaiMarketCard extends StatefulWidget {
  final StarLineMarketModel model;

  const MumbaiMarketCard({
    required this.model,
  });

  @override
  State<MumbaiMarketCard> createState() => _MumbaiMarketCardState();
}

class _MumbaiMarketCardState extends State<MumbaiMarketCard> {
  // @override
  ...
  //                     //     .compareTo("Next Day Bet Running!") ==
  //                     //     0)) {
  //                     //   Get.to(() => GameViewPage(
  //                     //     model: widget.model,
  //                     //   ));
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4.0),
                      Text(
                        "${widget.model.winningNumberStarLine}",
