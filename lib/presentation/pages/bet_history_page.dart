...
class _BetHistoryPageState extends State<BetHistoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bet History", style: TextStyle(fontWeight: FontWeight.bold)),
      ),
        ...
        child: Container(
          ...
          child: Container(
            ...
            child: NotificationListener<OverscrollIndicatorNotification>(
              ...
              child: ListView(
                scrollDirection: Axis.vertical,// Align to the left
                children: [
                    ...
                    return DateController.historyList.isEmpty
                      ...
                      children: List.generate(
                        DateController.historyList.length,
                            ...
                            DateController.historyList[index]),
                      ),
                    );
                  }),
                ],
  ...
  Future<void> transactionHistory() async {
    final url = Uri.parse("$baseUrl/transectionHistory.php");
